...
export const navbarContents: NavGroup[] = [
	{
			...
			},
      {
        ...
        navItemUrl: Constants.DASHBOARD_PAGE,
      },
		],
	},
...

  {
      ...
      {
        navItemName: "Chips With Text Box Page",
        navItemUrl: Constants.CHIPS_WITH_TEXTBOX,
      },
      {
        navItemName: "Fake Symbol Lookup Page",
        navItemUrl: Constants.SYMBOL_LOOKUP,
      },
      {
        navItemName: "Chips with Auto-Complete Page",
        navItemUrl: Constants.CHIPS_AUTO_COMPLETE,
      },
      {
        navItemName: "Grid Page With Chip Selection",
        navItemUrl: Constants.GRID_CHIP_SELECTION,
      },
