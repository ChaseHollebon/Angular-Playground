...
export enum Constants {
  ...
  PIE_CHART_LARGE                            = "page/dashboard/pie-chart",
  COLUMN_CHART_LARGE                         = "page/dashboard/column-chart",
  ZOOMABLE_CHART_LARGE                       = "page/dashboard/zoomable-chart-large",
  USA_STATE_CHART_LARGE                      = "page/dashboard/usa-state-chart-large",
  GAUGE_LARGE                                = "page/dashboard/gauge-large",
  CHIPS_WITH_TEXTBOX                         = "page/chips-with-textbox",
  SYMBOL_LOOKUP                              = "page/fake-symbol-lookup",
  CHIPS_AUTO_COMPLETE                        = "page/chips-autocomplete",
  GRID_CHIP_SELECTION                        = "page/grid-page-with-chip-selection",
