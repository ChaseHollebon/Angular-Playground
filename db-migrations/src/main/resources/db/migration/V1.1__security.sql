...
insert into uicontrols(id, name) values(5024, 'page/dashboard');
insert into uicontrols(id, name) values(5025, 'page/dashboard/pie-chart');
insert into uicontrols(id, name) values(5026, 'page/dashboard/column-chart');
insert into uicontrols(id, name) values(5027, 'page/dashboard/zoomable-chart-large');
insert into uicontrols(id, name) values(5028, 'page/dashboard/usa-state-chart-large');
insert into uicontrols(id, name) values(5029, 'page/dashboard/gauge-large');
insert into uicontrols(id, name) values(5030, 'page/chips-with-textbox');
insert into uicontrols(id, name) values(5031, 'page/fake-symbol-lookup');
insert into uicontrols(id, name) values(5033, 'page/chips-autocomplete');
insert into uicontrols(id, name) values(5034, 'page/grid-page-with-chip-selection');
